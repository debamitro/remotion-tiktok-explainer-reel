...
import { ExplainerGraphics } from "./ExplainerGraphics";
...
export const captionedVideoSchema = z.object({
  src: z.string(),
  hookText: z.string().default("AI Just Changed Coding Forever 🤯"),
});
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "white" }}>
      ...
      <AbsoluteFill
        style={{
          background:
            "linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 40%, transparent 80%, rgba(0,0,0,0.3) 100%)",
        }}
      />
